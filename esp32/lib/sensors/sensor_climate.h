...
inline void initClimate() {
  #if defined(SENSOR_BME280) || defined(SENSOR_BMP280) || defined(SENSOR_SHT31) || defined(SENSOR_AHT20) || defined(SENSOR_DHT11) || defined(SENSOR_DHT22) || defined(SENSOR_DS18B20)
    initClimateHardware();
  #endif
}
